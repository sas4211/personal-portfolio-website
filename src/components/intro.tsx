  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            ...
            <Image 
            src="/freelancer-earning-money.png"
              width="480"
              height="480"
              alt="portrait"
              quality="100"
      ...
      <h1 className="mb-10 mt-4 px-4 text-2xl sm:text-4xl">
        <span className="font-medium !leading-[1.5] ">Grow your business with a new attractive website.</span>{" "}
        <p className="text-[14px]">
         We are a full-service creative studio creating beautiful , interactive digital experiences and products.
        </p>
      </h1>
      </Fade>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/seo-copywriter-samina/"
          target="_blank"
          rel="noopener noreferrer"
          title="Link to LinkedIn profile of AI web developer Samina"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/sas4211"
          target="_blank"
          rel="noopener noreferrer"
          title="Link to GitHub profile of AI web developer Samina"
        >
          <FaGithubSquare />
        </a>
      </motion.div>
